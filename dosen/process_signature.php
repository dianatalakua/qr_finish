...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $fileName = $matkul_id .'_'. $username.'_'.$formattedDate.'.png';
    ...
    $insertSignatureQuery = "INSERT INTO tanda_tangan_dosen (id_dosen, id_matkul, tgl_tanda_tangan, tanda_tangan) VALUES (?, ?, CURDATE(), ?)";
    $stmt = $conn->prepare($insertSignatureQuery);
    $stmt->bind_param('sis',$username, $matkul_id, $filePath);
    $stmt->execute();
    $stmt->close();
